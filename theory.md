...
> This document provides the full theoretical background and implementation details for the RL+MPC three-legged locomotion system. For a project overview, quick start, and deployment instructions, see [README.md](README.md).
